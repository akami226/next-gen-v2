        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Basic platform settings</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#FF4500]/20 focus:border-[#FF4500]/40 transition-all"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1.5">Site URL</label>
              <input
                type="url"
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Access and authentication settings</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-3 border-t border-gray-100 first:border-t-0">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Automatically sign out after inactivity</p>
              </div>
              <select
                value={settings.sessionTimeout}
                onChange={(e) => setSettings((p) => ({ ...p, sessionTimeout: e.target.value }))}
                className="px-3 py-2 rounded-lg bg-gray-50 border border-gray-200 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#FF4500]/20 focus:border-[#FF4500]/40"
              >
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 rounded-xl bg-red-50/50 border border-red-100">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">This will permanently delete all platform data. This action cannot be undone.</p>
            </div>
            <button className="px-4 py-2 rounded-xl bg-white border border-red-200 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors shrink-0 ml-4">
              Reset
            </button>
          </div>
        </motion.div>
