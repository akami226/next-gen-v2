    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
          <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Configurator Pricing</h2>
          <p className="text-sm text-gray-500 mt-1">Manage pricing and inventory for all configurator items.</p>
        </motion.div>
        ...
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-xs ml-1 ${active ? 'text-white/60' : 'text-gray-400'}`}>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-5 py-3.5">Item</th>
                <th className="text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-5 py-3.5">Category</th>
                <th className="text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-5 py-3.5">Price</th>
                <th className="text-center text-[11px] font-semibold text-gray-500 uppercase tracking-wider px-5 py-3.5">Availability</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map((item, i) => {
                  ...
                  >
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div
                          className="w-10 h-10 rounded-xl border-2 border-gray-100 shrink-0"
                    ...
                    <td className="px-5 py-4">
                      <div className="relative w-32">
                        ...
                        <input
                          ...
                          className="w-full pl-7 pr-3 py-2 rounded-lg bg-gray-50 border border-gray-200 text-sm text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-[#FF4500]/20 focus:border-[#FF4500]/40 transition-all"
                        />
                      </div>
                    </td>
                    <td className="px-5 py-4">
                      <div className="flex justify-center">
                        ...
                        <span className={`ml-3 text-xs font-medium self-center ${item.inStock ? 'text-emerald-600' : 'text-gray-400'}`}>
