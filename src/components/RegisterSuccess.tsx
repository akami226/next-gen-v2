...
export default function RegisterSuccess({ data, onComplete }: RegisterSuccessProps) {
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-white/70 font-medium truncate">{data.email}</p>
          </div>
        </div>
